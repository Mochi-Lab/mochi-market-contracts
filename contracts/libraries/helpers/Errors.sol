...
library Errors {
    // common errors
    string public constant CALLER_NOT_MARKET_ADMIN =
        "Caller is not the market admin"; // 'The caller must be the market admin'
    ...
    string public constant CALLER_NOT_CONTRACT_OWNER =
        "Caller is not contract owner"; // 'The caller must be contract owner'

    string public constant CALLER_NOT_CREATIVE_STUDIO =
        "Caller is not creative studio"; // 'The caller must be creative studio'
    ...
    string public constant PERIOD_MUST_BE_GREATER_THAN_ZERO =
        "Period must be greater than zero"; // 'Invalid start time'
    ...
    string public constant NFT_NOT_APPROVED_FOR_MARKET =
        "NFT is not approved for Market"; // 'The nft must be approved for Market'
    ...
    string public constant PARAMETERS_NOT_MATCH =
        "The parameters are not match"; // 'The parameters must be match'
    string public constant EXCHANGE_ORDER_DUPLICATE =
        "Exchange order is duplicate"; // 'The exchange order must be unique'
